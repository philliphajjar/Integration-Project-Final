"""The Student guide for Success in Python Handbook"""
__author__ = 'Phillip Hajjar'
...
def checkIntValid(prompt):
    """The purpose of this function is to make my program not crash when user inputs something that isn't an integer"""
...
def checkFloatValid(prompt):
    """The purpose of this function is to make my program not crash when user inputs something that isn't a float"""
    got_good_input = False
    x = 0
    while not got_good_input:
        try:
...
def calculateArea(radius):
    """The purpose of this function is to calculate the area so that the function radius_main can run correctly and
    call onto this function to calculate the area """
    area = pow(radius, 2) * math.pi
    return area


def radius_main():
    """The purpose of this function is to demonstrate how to use user defined functions. I ask for a whole number
    input and the function finds the area."""
    radius = checkIntValid("choose a number between 1 and 10:  ")
    diameter = radius * 2
...
def main():
    ...
    if sprint_1 == 'yes':
        ...
        a = int(input1)
        b = int(input2)
        # Tyler gave great advice to make an if statement is someone inputs a value less than 10, it'll print the
        # statement, 'That number was less than 10:(' and then kill the program above we turned the input value into
        # an integer therefore we can use basic calculations on the inputs
        print("Below i will demonstrate numeric operators and their functions with two values of your choice.")
        print(
            "The first numeric operator we will use is '**' which is known as exponentiation, it places 'a' to the "
            "power of 'b'")
        print("a**b = ", a ** b)
        time.sleep(2)
        ...
        print(
            "Instead the '%' numeric operator is called the Modulus, which is the remainder of the division of 'a' "
            "value by the 'b'.")
        print("a%b = ", a % b)
        time.sleep(2)
        ...
        print(
            "At first I thought these operators had the same function as above, but they dont. They are similar "
            "although are not the same.")
    ...
    number_one = checkIntValid("For example, input a whole numbers:  ")
    # here I asked for a whole number to use in later lines of code
    number_two = checkIntValid("Perfect, input a second whole number:  ")
    ...
    print(
        "If-Else statements are used if something can either be true or false. The computer will check to see if the ")
    print(
        "information inside the if statement is true. If it is not true, it'll skip to the else statement and run that")
    print(
        "code. If there is no else statement, the computer will just skip the if statements and go to next line of "
        "code ")
    time.sleep(2)
    print('____________________________________________________________')
    ...
    age = checkIntValid("What is your age?")
    if age < 18:
        print("your a baby")
    elif age >= 18:
        print("your a adult")
    ...
    print('____________________________________________________________')
    print(
        "Next we will discuss, Relation Operators. This section will be super short. Ill use your previous numbers for "
        "the example")
    ...
    print('____________________________________________________________')
    print(
        "Next we will take a look at Boolean Operators, these are used to check and see if a expression is true or "
        "false")
    ...
    print(
        "While loops are defined as a control flow statement which allows code to be executed repeatedly, depending on "
    ...
    print(
        'A function definition could be used to determine the area of a circle and its diameter with a radius of your '
        'choosing')
    print(
        "First you would define how to calculate area, then you go to define the main function where you grab the "
        "users inputs and print the information needed.")
    print(
        "In this case the definition of calculateArea is needed in the main function so, that function is called to "
